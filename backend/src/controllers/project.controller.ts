...
import {ProjectRepository, UserProjectRepository} from '../repositories';
...
export class ProjectController {
  ...
  async create(
    ...
    project: Omit<Project, 'id' | 'createdBy' | 'createdAt'>,
  ): Promise<Project> {
    try {
      ...
      throw new HttpErrors.BadRequest('Unable to create project.');
    }
  }
